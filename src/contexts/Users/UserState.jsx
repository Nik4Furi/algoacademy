...
function UserState(props) {
  ...
  let username=null, email,tokenKey=null; 
  ...
  const postRegister = async (content) => {
    try {
      ...
      return setJsonRes(response);
    } catch (error) {
      console.log(error);
      return setJsonRes(error)
  ...
  return (
    <>
      <UserContext.Provider value={{ postRegister, postLogin,username,email,tokenKey,jsonRes}}>
        {props.children}
